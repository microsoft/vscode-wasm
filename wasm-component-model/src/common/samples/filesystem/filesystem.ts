...
export namespace filesystem {
        ...
        export declare function advise($this: descriptor, offset: filesize, length: filesize, advice: advice): result<, error_code>;
        export declare function sync_data($this: descriptor): result<, error_code>;
        ...
        export declare function set_size($this: descriptor, size: filesize): result<, error_code>;
        export declare function set_times($this: descriptor, data_access_timestamp: new_timestamp, data_modification_timestamp: new_timestamp): result<, error_code>;
        ...
        export declare function sync($this: descriptor): result<, error_code>;
        export declare function create_directory_at($this: descriptor, path: string): result<, error_code>;
