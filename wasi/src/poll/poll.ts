...
export namespace poll {
	...
	export namespace $cm {
		...
		export const $drop_pollable = new $wcm.FunctionSignature<drop_pollable>('drop_pollable', [
			['$this', $pollable]
		]);
		export const $poll_oneoff = new $wcm.FunctionSignature<poll_oneoff>('poll_oneoff', [
