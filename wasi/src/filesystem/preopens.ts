...
export namespace preopens {
	...
	export namespace $cm {
		...
		export const $get_directories = new $wcm.FunctionSignature('get_directories', [], new $wcm.ListType<[descriptor, string]>(new $wcm.TupleType<[descriptor, string]>([$descriptor, $wcm.wstring])));
	}
}
