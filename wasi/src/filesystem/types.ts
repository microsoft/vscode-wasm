...
export namespace types {
	...
	export type read_via_stream = typeof read_via_stream;
	...
	export type write_via_stream = typeof write_via_stream;
	...
	export type append_via_stream = typeof append_via_stream;
	...
	export type advise = typeof advise;
	...
	export type sync_data = typeof sync_data;
	...
	export type get_flags = typeof get_flags;
	...
	export type get_type = typeof get_type;
	...
	export type set_times = typeof set_times;
	...
	export type read_directory = typeof read_directory;
	...
	export type create_directory_at = typeof create_directory_at;
	...
	export type stat_at = typeof stat_at;
	...
	export type set_times_at = typeof set_times_at;
	...
	export type link_at = typeof link_at;
	...
	export type open_at = typeof open_at;
	...
	export type readlink_at = typeof readlink_at;
	...
	export type remove_directory_at = typeof remove_directory_at;
	...
	export type rename_at = typeof rename_at;
	...
	export type symlink_at = typeof symlink_at;
	...
	export type access_at = typeof access_at;
	...
	export type unlink_file_at = typeof unlink_file_at;
	...
	export type change_file_permissions_at = typeof change_file_permissions_at;
	...
	export type change_directory_permissions_at = typeof change_directory_permissions_at;
	...
	export type lock_shared = typeof lock_shared;
	...
	export type lock_exclusive = typeof lock_exclusive;
	...
	export type try_lock_shared = typeof try_lock_shared;
	...
	export type try_lock_exclusive = typeof try_lock_exclusive;
	...
	export type drop_descriptor = typeof drop_descriptor;
	...
	export type read_directory_entry = typeof read_directory_entry;
	...
	export type drop_directory_entry_stream = typeof drop_directory_entry_stream;
	...
	export type is_same_object = typeof is_same_object;
	...
	export type metadata_hash = typeof metadata_hash;
	...
	export type metadata_hash_at = typeof metadata_hash_at;
	...
	export namespace $cm {
		...
		export const $read_via_stream = new $wcm.FunctionType<read_via_stream>('read_via_stream', [
			['$this', $descriptor], ['offset', $filesize]
		], new $wcm.ResultType<input_stream, error_code>($input_stream, $error_code));
		export const $write_via_stream = new $wcm.FunctionType<write_via_stream>('write_via_stream', [
			['$this', $descriptor], ['offset', $filesize]
		], new $wcm.ResultType<output_stream, error_code>($output_stream, $error_code));
		export const $append_via_stream = new $wcm.FunctionType<append_via_stream>('append_via_stream', [
			['$this', $descriptor]
		], new $wcm.ResultType<output_stream, error_code>($output_stream, $error_code));
		export const $advise = new $wcm.FunctionType<advise>('advise', [
			['$this', $descriptor], ['offset', $filesize], ['length', $filesize], ['advice', $advice]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $sync_data = new $wcm.FunctionType<sync_data>('sync_data', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $get_flags = new $wcm.FunctionType<get_flags>('get_flags', [
			['$this', $descriptor]
		], new $wcm.ResultType<descriptor_flags, error_code>($descriptor_flags, $error_code));
		export const $get_type = new $wcm.FunctionType<get_type>('get_type', [
			['$this', $descriptor]
		], new $wcm.ResultType<descriptor_type, error_code>($descriptor_type, $error_code));
		export const $set_size = new $wcm.FunctionType<set_size>('set_size', [
			['$this', $descriptor], ['size', $filesize]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $set_times = new $wcm.FunctionType<set_times>('set_times', [
		...
		export const $read_directory = new $wcm.FunctionType<read_directory>('read_directory', [
			['$this', $descriptor]
		], new $wcm.ResultType<directory_entry_stream, error_code>($directory_entry_stream, $error_code));
		export const $sync = new $wcm.FunctionType<sync>('sync', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $create_directory_at = new $wcm.FunctionType<create_directory_at>('create_directory_at', [
			['$this', $descriptor], ['path', $wcm.wstring]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $stat = new $wcm.FunctionType<stat>('stat', [
			['$this', $descriptor]
		], new $wcm.ResultType<descriptor_stat, error_code>($descriptor_stat, $error_code));
		export const $stat_at = new $wcm.FunctionType<stat_at>('stat_at', [
			['$this', $descriptor], ['path_flags', $path_flags], ['path', $wcm.wstring]
		], new $wcm.ResultType<descriptor_stat, error_code>($descriptor_stat, $error_code));
		export const $set_times_at = new $wcm.FunctionType<set_times_at>('set_times_at', [
		...
		export const $link_at = new $wcm.FunctionType<link_at>('link_at', [
			['$this', $descriptor], ['old_path_flags', $path_flags], ['old_path', $wcm.wstring], ['new_descriptor', $descriptor], ['new_path', $wcm.wstring]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $open_at = new $wcm.FunctionType<open_at>('open_at', [
		...
		export const $readlink_at = new $wcm.FunctionType<readlink_at>('readlink_at', [
			['$this', $descriptor], ['path', $wcm.wstring]
		], new $wcm.ResultType<string, error_code>($wcm.wstring, $error_code));
		export const $remove_directory_at = new $wcm.FunctionType<remove_directory_at>('remove_directory_at', [
			['$this', $descriptor], ['path', $wcm.wstring]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $rename_at = new $wcm.FunctionType<rename_at>('rename_at', [
			['$this', $descriptor], ['old_path', $wcm.wstring], ['new_descriptor', $descriptor], ['new_path', $wcm.wstring]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $symlink_at = new $wcm.FunctionType<symlink_at>('symlink_at', [
			['$this', $descriptor], ['old_path', $wcm.wstring], ['new_path', $wcm.wstring]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $access_at = new $wcm.FunctionType<access_at>('access_at', [
			['$this', $descriptor], ['path_flags', $path_flags], ['path', $wcm.wstring], ['type', $access_type]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $unlink_file_at = new $wcm.FunctionType<unlink_file_at>('unlink_file_at', [
			['$this', $descriptor], ['path', $wcm.wstring]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $change_file_permissions_at = new $wcm.FunctionType<change_file_permissions_at>('change_file_permissions_at', [
			['$this', $descriptor], ['path_flags', $path_flags], ['path', $wcm.wstring], ['modes', $modes]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $change_directory_permissions_at = new $wcm.FunctionType<change_directory_permissions_at>('change_directory_permissions_at', [
			['$this', $descriptor], ['path_flags', $path_flags], ['path', $wcm.wstring], ['modes', $modes]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $lock_shared = new $wcm.FunctionType<lock_shared>('lock_shared', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $lock_exclusive = new $wcm.FunctionType<lock_exclusive>('lock_exclusive', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $try_lock_shared = new $wcm.FunctionType<try_lock_shared>('try_lock_shared', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $try_lock_exclusive = new $wcm.FunctionType<try_lock_exclusive>('try_lock_exclusive', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $unlock = new $wcm.FunctionType<unlock>('unlock', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $drop_descriptor = new $wcm.FunctionType<drop_descriptor>('drop_descriptor', [
			['$this', $descriptor]
		]);
		export const $read_directory_entry = new $wcm.FunctionType<read_directory_entry>('read_directory_entry', [
		...
		export const $drop_directory_entry_stream = new $wcm.FunctionType<drop_directory_entry_stream>('drop_directory_entry_stream', [
			['$this', $directory_entry_stream]
		]);
		export const $is_same_object = new $wcm.FunctionType<is_same_object>('is_same_object', [
			['$this', $descriptor], ['other', $descriptor]
		], $wcm.bool);
		export const $metadata_hash = new $wcm.FunctionType<metadata_hash>('metadata_hash', [
			['$this', $descriptor]
		], new $wcm.ResultType<metadata_hash_value, error_code>($metadata_hash_value, $error_code));
		export const $metadata_hash_at = new $wcm.FunctionType<metadata_hash_at>('metadata_hash_at', [
			['$this', $descriptor], ['path_flags', $path_flags], ['path', $wcm.wstring]
		], new $wcm.ResultType<metadata_hash_value, error_code>($metadata_hash_value, $error_code));
		export namespace $ {
			const allFunctions = [$read_via_stream, $write_via_stream, $append_via_stream, $advise, $sync_data, $get_flags, $get_type, $set_size, $set_times, $read, $write, $read_directory, $sync, $create_directory_at, $stat, $stat_at, $set_times_at, $link_at, $open_at, $readlink_at, $remove_directory_at, $rename_at, $symlink_at, $access_at, $unlink_file_at, $change_file_permissions_at, $change_directory_permissions_at, $lock_shared, $lock_exclusive, $try_lock_shared, $try_lock_exclusive, $unlock, $drop_descriptor, $read_directory_entry, $drop_directory_entry_stream, $is_same_object, $metadata_hash, $metadata_hash_at];
			export function createHost<T extends $wcm.Host>(service: types, context: $wcm.Context): T {
				return $wcm.Host.create<T>(allFunctions, service, context);
			}
			export function createService<T extends types>(wasmInterface: $wcm.WasmInterface, context: $wcm.Context): T {
