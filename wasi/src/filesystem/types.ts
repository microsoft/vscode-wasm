...
export namespace types {
	...
	export namespace $cm {
		...
		export const $read_via_stream = new $wcm.FunctionSignature<read_via_stream>('read_via_stream', [
			['$this', $descriptor], ['offset', $filesize]
		], new $wcm.ResultType<input_stream, error_code>($input_stream, $error_code));
		export const $write_via_stream = new $wcm.FunctionSignature<write_via_stream>('write_via_stream', [
			['$this', $descriptor], ['offset', $filesize]
		], new $wcm.ResultType<output_stream, error_code>($output_stream, $error_code));
		export const $append_via_stream = new $wcm.FunctionSignature<append_via_stream>('append_via_stream', [
			['$this', $descriptor]
		], new $wcm.ResultType<output_stream, error_code>($output_stream, $error_code));
		export const $advise = new $wcm.FunctionSignature<advise>('advise', [
			['$this', $descriptor], ['offset', $filesize], ['length', $filesize], ['advice', $advice]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $sync_data = new $wcm.FunctionSignature<sync_data>('sync_data', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $get_flags = new $wcm.FunctionSignature<get_flags>('get_flags', [
			['$this', $descriptor]
		], new $wcm.ResultType<descriptor_flags, error_code>($descriptor_flags, $error_code));
		export const $get_type = new $wcm.FunctionSignature<get_type>('get_type', [
			['$this', $descriptor]
		], new $wcm.ResultType<descriptor_type, error_code>($descriptor_type, $error_code));
		export const $set_size = new $wcm.FunctionSignature<set_size>('set_size', [
			['$this', $descriptor], ['size', $filesize]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $set_times = new $wcm.FunctionSignature<set_times>('set_times', [
		...
		export const $read_directory = new $wcm.FunctionSignature<read_directory>('read_directory', [
			['$this', $descriptor]
		], new $wcm.ResultType<directory_entry_stream, error_code>($directory_entry_stream, $error_code));
		export const $sync = new $wcm.FunctionSignature<sync>('sync', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $create_directory_at = new $wcm.FunctionSignature<create_directory_at>('create_directory_at', [
			['$this', $descriptor], ['path', $wcm.wstring]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $stat = new $wcm.FunctionSignature<stat>('stat', [
			['$this', $descriptor]
		], new $wcm.ResultType<descriptor_stat, error_code>($descriptor_stat, $error_code));
		export const $stat_at = new $wcm.FunctionSignature<stat_at>('stat_at', [
			['$this', $descriptor], ['path_flags', $path_flags], ['path', $wcm.wstring]
		], new $wcm.ResultType<descriptor_stat, error_code>($descriptor_stat, $error_code));
		export const $set_times_at = new $wcm.FunctionSignature<set_times_at>('set_times_at', [
		...
		export const $link_at = new $wcm.FunctionSignature<link_at>('link_at', [
			['$this', $descriptor], ['old_path_flags', $path_flags], ['old_path', $wcm.wstring], ['new_descriptor', $descriptor], ['new_path', $wcm.wstring]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $open_at = new $wcm.FunctionSignature<open_at>('open_at', [
		...
		export const $readlink_at = new $wcm.FunctionSignature<readlink_at>('readlink_at', [
			['$this', $descriptor], ['path', $wcm.wstring]
		], new $wcm.ResultType<string, error_code>($wcm.wstring, $error_code));
		export const $remove_directory_at = new $wcm.FunctionSignature<remove_directory_at>('remove_directory_at', [
			['$this', $descriptor], ['path', $wcm.wstring]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $rename_at = new $wcm.FunctionSignature<rename_at>('rename_at', [
			['$this', $descriptor], ['old_path', $wcm.wstring], ['new_descriptor', $descriptor], ['new_path', $wcm.wstring]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $symlink_at = new $wcm.FunctionSignature<symlink_at>('symlink_at', [
			['$this', $descriptor], ['old_path', $wcm.wstring], ['new_path', $wcm.wstring]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $access_at = new $wcm.FunctionSignature<access_at>('access_at', [
			['$this', $descriptor], ['path_flags', $path_flags], ['path', $wcm.wstring], ['type', $access_type]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $unlink_file_at = new $wcm.FunctionSignature<unlink_file_at>('unlink_file_at', [
			['$this', $descriptor], ['path', $wcm.wstring]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $change_file_permissions_at = new $wcm.FunctionSignature<change_file_permissions_at>('change_file_permissions_at', [
			['$this', $descriptor], ['path_flags', $path_flags], ['path', $wcm.wstring], ['modes', $modes]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $change_directory_permissions_at = new $wcm.FunctionSignature<change_directory_permissions_at>('change_directory_permissions_at', [
			['$this', $descriptor], ['path_flags', $path_flags], ['path', $wcm.wstring], ['modes', $modes]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $lock_shared = new $wcm.FunctionSignature<lock_shared>('lock_shared', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $lock_exclusive = new $wcm.FunctionSignature<lock_exclusive>('lock_exclusive', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $try_lock_shared = new $wcm.FunctionSignature<try_lock_shared>('try_lock_shared', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $try_lock_exclusive = new $wcm.FunctionSignature<try_lock_exclusive>('try_lock_exclusive', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $unlock = new $wcm.FunctionSignature<unlock>('unlock', [
			['$this', $descriptor]
		], new $wcm.ResultType<void, error_code>(undefined, $error_code));
		export const $drop_descriptor = new $wcm.FunctionSignature<drop_descriptor>('drop_descriptor', [
			['$this', $descriptor]
		]);
		export const $read_directory_entry = new $wcm.FunctionSignature<read_directory_entry>('read_directory_entry', [
		...
		export const $drop_directory_entry_stream = new $wcm.FunctionSignature<drop_directory_entry_stream>('drop_directory_entry_stream', [
			['$this', $directory_entry_stream]
		]);
		export const $is_same_object = new $wcm.FunctionSignature<is_same_object>('is_same_object', [
			['$this', $descriptor], ['other', $descriptor]
		], $wcm.bool);
		export const $metadata_hash = new $wcm.FunctionSignature<metadata_hash>('metadata_hash', [
			['$this', $descriptor]
		], new $wcm.ResultType<metadata_hash_value, error_code>($metadata_hash_value, $error_code));
		export const $metadata_hash_at = new $wcm.FunctionSignature<metadata_hash_at>('metadata_hash_at', [
			['$this', $descriptor], ['path_flags', $path_flags], ['path', $wcm.wstring]
		], new $wcm.ResultType<metadata_hash_value, error_code>($metadata_hash_value, $error_code));
	}
}
