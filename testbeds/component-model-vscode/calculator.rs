...
pub unsafe fn _export_calc_cabi<T: Guest>(arg0: i32,arg1: i32,arg2: i32,) -> i32 {use vscode::example::types::Operation as V0;
let v0 = match arg0 {
  0 => {
...
impl Guest for Stub {
  fn calc(o: Operation,) -> u32{ unreachable!() }
}
impl exports::vscode::example::workspace_events::Guest for Stub {
  fn did_change_text_document(uri: _rt::String,){ unreachable!() }
}
impl exports::vscode::example::commands_events::Guest for Stub {
  fn execute(command: _rt::String,){ unreachable!() }
}
pub mod vscode {
  pub mod example {
    #[allow(clippy::all)]
    pub mod workspace {
      ...
      pub fn register_on_did_change_text_document(){
        unsafe {
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "vscode:example/workspace")]
          extern "C" {
    ...
    pub mod commands {
      ...
      pub fn register(command: &str,){
        unsafe {
          ...
          #[cfg(target_arch = "wasm32")]
          #[link(wasm_import_module = "vscode:example/commands")]
          extern "C" {
            #[link_name = "register"]
  ...
  pub mod vscode {
    pub mod example {
      ...
      pub mod workspace_events {
        ...
        #[doc(hidden)]
        #[allow(non_snake_case)]
        pub unsafe fn _export_did_change_text_document_cabi<T: Guest>(arg0: *mut u8,arg1: usize,) {let len0 = arg1;
      ...
      macro_rules! __export_vscode_example_workspace_events_cabi{
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

          #[export_name = "vscode:example/workspace-events#did-change-text-document"]
          unsafe extern "C" fn export_did_change_text_document(arg0: *mut u8,arg1: usize,) {
            $($path_to_types)*::_export_did_change_text_document_cabi::<$ty>(arg0, arg1)
          }
        };);
      }
      #[doc(hidden)]
      pub(crate) use __export_vscode_example_workspace_events_cabi;
    ...
    pub mod commands_events {
      ...
      #[doc(hidden)]
      #[allow(non_snake_case)]
      pub unsafe fn _export_execute_cabi<T: Guest>(arg0: *mut u8,arg1: usize,) {let len0 = arg1;
      let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
    ...
    macro_rules! __export_vscode_example_commands_events_cabi{
      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

        #[export_name = "vscode:example/commands-events#execute"]
        unsafe extern "C" fn export_execute(arg0: *mut u8,arg1: usize,) {
          $($path_to_types)*::_export_execute_cabi::<$ty>(arg0, arg1)
        }
      };);
    }
    #[doc(hidden)]
    pub(crate) use __export_vscode_example_commands_events_cabi;
...
macro_rules! __export_calculator_impl {
  ...
  $($path_to_types_root)*::exports::vscode::example::workspace_events::__export_vscode_example_workspace_events_cabi!($ty with_types_in $($path_to_types_root)*::exports::vscode::example::workspace_events);
  $($path_to_types_root)*::exports::vscode::example::commands_events::__export_vscode_example_commands_events_cabi!($ty with_types_in $($path_to_types_root)*::exports::vscode::example::commands_events);
  )
}
#[doc(inline)]
...
\x08register\x01\0\x03\x01\x17vscode:example/commands\x05\x01\x01B#\x01r\x02\x04\
lefty\x05righty\x04\0\x08operands\x03\0\0\x01q\x04\x03add\x01\x01\0\x03sub\x01\x01\
\0\x03mul\x01\x01\0\x03div\x01\x01\0\x04\0\x09operation\x03\0\x02\x01r\x02\x04li\
ney\x09charactery\x04\0\x08position\x03\0\x04\x01r\x02\x05start\x05\x03end\x05\x04\
\0\x05range\x03\0\x06\x01r\x04\x05range\x07\x0crange-offsety\x0crange-lengthy\x04\
texts\x04\0\"text-document-content-change-event\x03\0\x08\x04\0\x0dtext-document\
\x03\x01\x01m\x02\x04undo\x04redo\x04\0\x1btext-document-change-reason\x03\0\x0b\
\x01i\x0a\x01p\x09\x01k\x0c\x01r\x03\x08document\x0d\x0fcontent-changes\x0e\x06r\
eason\x0f\x04\0\x1atext-document-change-event\x03\0\x10\x04\0\x0eoutput-channel\x03\
\x01\x01h\x0a\x01@\x01\x04self\x13\0s\x04\0\x19[method]text-document.uri\x01\x14\
\x04\0![method]text-document.language-id\x01\x14\x01@\x01\x04self\x13\0y\x04\0\x1d\
[method]text-document.version\x01\x15\x04\0\x1e[method]text-document.get-text\x01\
\x14\x01h\x12\x01@\x01\x04self\x16\0s\x04\0\x1b[method]output-channel.name\x01\x17\
\x01@\x02\x04self\x16\x05values\x01\0\x04\0\x1d[method]output-channel.append\x01\
\x18\x04\0\"[method]output-channel.append-line\x01\x18\x01@\x01\x04self\x16\x01\0\
\x04\0\x1c[method]output-channel.clear\x01\x19\x04\0\x1b[method]output-channel.s\
how\x01\x19\x03\x01\x14vscode:example/types\x05\x02\x02\x03\0\x02\x0eoutput-chan\
nel\x01B\x06\x02\x03\x02\x01\x03\x04\0\x0eoutput-channel\x03\0\0\x01ks\x01i\x01\x01\
@\x02\x04names\x0blanguage-id\x02\0\x03\x04\0\x15create-output-channel\x01\x04\x03\
\x01\x15vscode:example/window\x05\x04\x02\x03\0\x02\x09operation\x03\0\x09operat\
ion\x03\0\x05\x01@\x01\x01o\x06\0y\x04\0\x04calc\x01\x07\x01B\x02\x01@\x01\x03ur\
is\x01\0\x04\0\x18did-change-text-document\x01\0\x04\x01\x1fvscode:example/works\
pace-events\x05\x08\x01B\x02\x01@\x01\x07commands\x01\0\x04\0\x07execute\x01\0\x04\
\x01\x1evscode:example/commands-events\x05\x09\x04\x01\x19vscode:example/calcula\
tor\x04\0\x0b\x10\x01\0\x0acalculator\x03\0\0\0G\x09producers\x01\x0cprocessed-b\
